...
Use code to map you path through knowledge. Play, connect, make meaning as you work to assemble a webtext.

This repository will allow the user mix and match div. blocks to build a quick web communication similar to an Adobe Spark. https://spark.adobe.com... but through the process the user will learn more about computer science and computer literacy. 
    
## Get started!
 

1. Go to repository: [HERE](https://github.com/Pitt-Fuego/directed-reading)
